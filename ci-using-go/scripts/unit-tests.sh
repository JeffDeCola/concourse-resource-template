...
echo "The goal is to set up a go src/github.com/JeffDeCola/concourse-resource-template directory"
...
echo "cp -R ./concourse-resource-template src/github.com/JeffDeCola/."
cp -R ./concourse-resource-template src/github.com/JeffDeCola/.
echo " "

echo "cd src/github.com/JeffDeCola/concourse-resource-template/build-resource-using-bash"
cd src/github.com/JeffDeCola/concourse-resource-template/build-resource-using-bash
echo " "
...
# echo "mkdir -p test"
# mkdir -p test
# echo "Placeholder to run go tests for concourse-resource-template" | tee test/test_coverage.txt
# echo " "
