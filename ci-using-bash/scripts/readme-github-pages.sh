#!/bin/sh
# concourse-resource-template readme-github-pages.sh
...
echo "The goal is to git clone /concourse-resource-template to /concourse-resource-template-updated"
...
echo "git clone concourse-resource-template to concourse-resource-template-updated"
git clone concourse-resource-template concourse-resource-template-updated
echo " "

echo "cd concourse-resource-template-updated"
cd concourse-resource-template-updated
echo " "
...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/concourse-resource-template\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/concourse-resource-template\/master\/svgs\//g' temp-README.md
echo " "
